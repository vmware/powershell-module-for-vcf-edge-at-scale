#
# Module manifest for 'ModernEdgeAtScale'
...
RootModule = 'ModernEdgeAtScale.psm1'
...
Description = @'
Modern Edge at Scale: automates end-to-end deployment of a vSphere Supervisor in VMware Cloud Foundation 9.x.
...
- Argo CD installation and configuration for GitOps workflows
- Optional Harbor Supervisor Service deployment when configured in infrastructure JSON
'@
...
FileList = @(
    'ModernEdgeAtScale.psd1',
    'ModernEdgeAtScale.psm1',
